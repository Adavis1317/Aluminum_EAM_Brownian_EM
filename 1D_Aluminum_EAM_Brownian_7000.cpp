...
void write_to_csv_file(int presentAtom, double atomParameter, double presentTime, int flag) {
    ...
    if (flag == 1) {
        ...
        if (presentAtom == 0) {
            ...
            positions = fopen("Positions7000-1.csv", "a");
        ...
        if (presentAtom == 0) {
            ...
            accelerations = fopen("Accelerations7000-1.csv", "a");
        ...
        if (presentAtom == 0) {
            ...
            velocities = fopen("Velocities7000-1.csv", "a");
        ...
        zeroTempComponent = fopen("zeroTempComponent7000-1.csv", "a");
        ...
        potentialComponent = fopen("potentialComponent7000-1.csv", "a");
