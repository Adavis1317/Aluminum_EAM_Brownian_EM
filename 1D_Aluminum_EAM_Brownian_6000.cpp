...
void write_to_csv_file(int presentAtom, double atomParameter, double presentTime, int flag) {
    ...
    if (flag == 1) {
        ...
        if (presentAtom == 0) {
            ...
            positions = fopen("Positions6000-1.csv", "a");
        ...
        if (presentAtom == 0) {
            ...
            accelerations = fopen("Accelerations6000-1.csv", "a");
        ...
        if (presentAtom == 0) {
            ...
            velocities = fopen("Velocities6000-1.csv", "a");
        ...
        zeroTempComponent = fopen("zeroTempComponent6000-1.csv", "a");
        ...
        potentialComponent = fopen("potentialComponent6000-1.csv", "a");
