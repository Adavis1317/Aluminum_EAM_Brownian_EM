...
void write_to_csv_file(int presentAtom, double atomParameter, double presentTime, int flag) {
    ...
    if (flag == 1) {
        ...
        if (presentAtom == 0) {
            ...
            positions = fopen("Positions8000-1.csv", "a");
        ...
        if (presentAtom == 0) {
            ...
            accelerations = fopen("Accelerations8000-1.csv", "a");
        ...
        if (presentAtom == 0) {
            ...
            velocities = fopen("Velocities8000-1.csv", "a");
        ...
        zeroTempComponent = fopen("zeroTempComponent8000-1.csv", "a");
        ...
        potentialComponent = fopen("potentialComponent8000-1.csv", "a");
